...
# 配置文件路径
$STORAGE_FILE = "$env:APPDATA\Windsurf\User\globalStorage\storage.json"
$BACKUP_DIR = "$env:APPDATA\Windsurf\User\globalStorage\backups"
...
function Get-CursorVersion {
    try {
        ...
        # 备用路径检测
        $altPath = "$env:LOCALAPPDATA\windsurf\resources\app\package.json"
